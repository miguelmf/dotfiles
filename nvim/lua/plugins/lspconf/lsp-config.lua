...
-- vim.keymap.set('n', '<C-e>', vim.diagnostic.open_float, opts('Open Diagnostic Window'))
...
vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(ev)
        ...
        vim.keymap.set('n', '<C-h>', vim.lsp.buf.hover, bufopts('Hover'))
        -- vim.keymap.set('n', 'gI', vim.lsp.buf.implementation, bufopts('Go to Implementation'))
        -- vim.keymap.set('n', '<C-g>', vim.lsp.buf.signature_help, bufopts('Singature Help'))
        ...
        vim.keymap.set('n', '<C-e>', vim.lsp.buf.references, bufopts('Go to Reference'))
